          ...
          <div class="tm-bg-primary-dark tm-block tm-block-h-auto">
            <div class="row">
              <div class="col-12 text-center">
                <h2 class="tm-block-title mb-4">인증번호 입력</h2>
              </div>
            </div>
            <div class="row mt-2">
              <div class="col-12">
              <!-- 로그인을 위한 데이터를 넘기기 위한 form 액션 -->
                <form name="f" action="/user/changeAdminPwd.do" method="post" class="tm-login-form" onsubmit="return randomCheck(this);">
                  <div class="form-group">
                  
                    <label for="aEmail">메일 인증번호</label> 
                    <input
                      name="check"
                      type="text"
