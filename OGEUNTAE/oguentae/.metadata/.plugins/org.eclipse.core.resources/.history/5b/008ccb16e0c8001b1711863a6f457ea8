          ...
          <div class="tm-bg-primary-dark tm-block tm-block-h-auto">
            ...
            <div class="row mt-2">
              ...
              <!-- 로그인을 위한 데이터를 넘기기 위한 form 액션 -->
                <form name="f" action="/user/findAdminMail.do" method="post" class="tm-login-form" onsubmit="return doRegUserCheck(this);">
                  <div class="form-group">
                  
                    <label for="aEmail">가입 시 사용한 이메일</label> 
                    <input
                      name="aEmail"
                      type="text"
...
/*     
    function sendRandomMail() {
    	console.log('진입');
		let pEmail = document.getElementById("aEmail");
		
		$.ajax({
			url: '/user/sendRandomMial.do',
			type: 'POST',
